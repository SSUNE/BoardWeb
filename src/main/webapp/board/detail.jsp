...
<div class="container"  style="margin-top:5%; min-height:500px">
    ...
    <div class="text-right"    >
        ...
        <a href="<%=request.getContextPath() %>/edit_view.do?bno=${dto.bno}"   class="btn btn-basic" >수정</a>
        <a href="<%=request.getContextPath() %>/delete_view.do?bno=${dto.bno}"   class="btn btn-basic" >삭제</a>
        <a href="<%=request.getContextPath() %>/list.do"   class="btn btn-basic" >목록보기</a>
    </div>
</div>
